            ...
            _vm._ssrNode(
              " " +
                (_vm.basketNotifications.length > 0
                  ? "<div>" +
                    _vm._ssrList(_vm.basketNotifications, function(
                      notification
                    ) {
                      return (
                        '<div class="w-100 alert alert-danger"><div>' +
                        _vm._ssrEscape(_vm._s(notification.message)) +
                        "</div></div>"
                      )
                    }) +
                    "</div>"
...
//# sourceMappingURL=ceres-server-17.js.map