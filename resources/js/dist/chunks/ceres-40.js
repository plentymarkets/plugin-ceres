...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    getClosestVariation: function getClosestVariation(qualifiedVariations) {
      ...
      var _iterator4 = _createForOfIteratorHelper(qualifiedVariations),
          _step4;

      try {
        for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
          var _variation = _step4.value;
          var changes = 0;

          if (_variation.unitCombinationId !== this.selectedUnit && !Object(_helper_utils__WEBPACK_IMPORTED_MODULE_19__["isNull"])(this.selectedUnit)) {
            changes++;
          }

          var _iterator5 = _createForOfIteratorHelper(_variation.attributes),
              _step5;
