...
/* harmony import */ var _BasketSetComponentList_vue__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ./BasketSetComponentList.vue */ "./resources/js/src/app/components/basket/list/BasketSetComponentList.vue");
/* harmony import */ var _item_OrderPropertyValueList_vue__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ../../item/OrderPropertyValueList.vue */ "./resources/js/src/app/components/item/OrderPropertyValueList.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    BasketSetComponentList: _BasketSetComponentList_vue__WEBPACK_IMPORTED_MODULE_30__["default"],
    OrderPropertyValueList: _item_OrderPropertyValueList_vue__WEBPACK_IMPORTED_MODULE_31__["default"]
  },
  props: {
    template: {
      type: String,
  ...
  computed: _objectSpread({
    ...
    unitPrice: function unitPrice() {
      ...
      if (Object(_helper_utils__WEBPACK_IMPORTED_MODULE_28__["isDefined"])(this.basketItem.setComponents)) {
    ...
    basePrice: function basePrice() {
      ...
      if (!Object(_helper_utils__WEBPACK_IMPORTED_MODULE_28__["isNullOrUndefined"])(this.basketItem.updatedBasePrice)) {
        return this.basketItem.updatedBasePrice;
      }
      if (!Object(_helper_utils__WEBPACK_IMPORTED_MODULE_28__["isNullOrUndefined"])(this.basketItem.variation.data.prices.specialOffer)) {
        return this.basketItem.variation.data.prices.specialOffer.basePrice;
      }
      if (!Object(_helper_utils__WEBPACK_IMPORTED_MODULE_28__["isNullOrUndefined"])(this.basketItem.variation.data.prices.graduatedPrices)) {
        var calculatedPrice = null;
        this.basketItem.variation.data.prices.graduatedPrices.forEach(function (price) {
          if (Object(_helper_utils__WEBPACK_IMPORTED_MODULE_28__["isNullOrUndefined"])(calculatedPrice) && _this.basketItem.quantity >= price.minimumOrderQuantity) {
        ...
        if (!Object(_helper_utils__WEBPACK_IMPORTED_MODULE_28__["isNullOrUndefined"])(calculatedPrice)) {
