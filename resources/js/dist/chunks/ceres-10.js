...
/* harmony import */ var _BasketSetComponentList_vue__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ./BasketSetComponentList.vue */ "./resources/js/src/app/components/basket/list/BasketSetComponentList.vue");
/* harmony import */ var _item_OrderPropertyValueList_vue__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ../../item/OrderPropertyValueList.vue */ "./resources/js/src/app/components/item/OrderPropertyValueList.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    BasketSetComponentList: _BasketSetComponentList_vue__WEBPACK_IMPORTED_MODULE_28__["default"],
    OrderPropertyValueList: _item_OrderPropertyValueList_vue__WEBPACK_IMPORTED_MODULE_29__["default"]
  },
  props: {
    template: {
      type: String,
  ...
  computed: _objectSpread({
    ...
    unitPrice: function unitPrice() {
      ...
      if (Object(_helper_utils__WEBPACK_IMPORTED_MODULE_26__["isDefined"])(this.basketItem.setComponents)) {
    ...
    basePrice: function basePrice() {
      ...
      if (!Object(_helper_utils__WEBPACK_IMPORTED_MODULE_26__["isNullOrUndefined"])(this.basketItem.updatedBasePrice)) {
        return this.basketItem.updatedBasePrice;
      }

      if (!Object(_helper_utils__WEBPACK_IMPORTED_MODULE_26__["isNullOrUndefined"])(this.basketItem.variation.data.prices.specialOffer)) {
        return this.basketItem.variation.data.prices.specialOffer.basePrice;
      }

      if (!Object(_helper_utils__WEBPACK_IMPORTED_MODULE_26__["isNullOrUndefined"])(this.basketItem.variation.data.prices.graduatedPrices)) {
        var calculatedPrice = null;
        this.basketItem.variation.data.prices.graduatedPrices.forEach(function (price) {
          if (Object(_helper_utils__WEBPACK_IMPORTED_MODULE_26__["isNullOrUndefined"])(calculatedPrice) && _this.basketItem.quantity >= price.minimumOrderQuantity) {
        ...
        if (!Object(_helper_utils__WEBPACK_IMPORTED_MODULE_26__["isNullOrUndefined"])(calculatedPrice)) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            if (newAttribute.value) {
              if (this.newAttributeValues !== null && "object" === _typeof(this.newAttributeValues) && newAttribute.value.id in this.newAttributeValues && this.newAttributeValues[newAttribute.value.id].trim() != "" && newAttribute.value.names.name) {
    ...
    newAttributeValues: function newAttributeValues() {
      if (this.basketItem.variation.data && this.basketItem.variation.data.variationProperties) {
        var _iterator4 = _createForOfIteratorHelper(this.basketItem.variation.data.variationProperties),
            _step4;
        ...
        this.$store.dispatch("updateBasketItemQuantity", {
          ...
          if (_this3.isPreview) {
            _this3.$store.dispatch("addBasketNotification", {
              type: "error",
              message: _services_TranslationService__WEBPACK_IMPORTED_MODULE_25__["default"].translate("Ceres::Template." + _exceptions_ExceptionMap__WEBPACK_IMPORTED_MODULE_24__["default"].get(error.data.exceptionCode.toString()), error.data.placeholder)
            });
          } else {
            NotificationService.error(_services_TranslationService__WEBPACK_IMPORTED_MODULE_25__["default"].translate("Ceres::Template." + _exceptions_ExceptionMap__WEBPACK_IMPORTED_MODULE_24__["default"].get(error.data.exceptionCode.toString()), error.data.placeholder)).closeAfter(5000);
          }
