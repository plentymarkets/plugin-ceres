  ...
  mounted: function mounted() {
    ...
    this.$nextTick(function () {
      if (!Object(_helper_utils__WEBPACK_IMPORTED_MODULE_1__["isNullOrUndefined"])(_this.$refs.node) && !Object(_helper_utils__WEBPACK_IMPORTED_MODULE_1__["isNullOrUndefined"])(_this.$refs.handle)) {
        ...
        _this.popper = Object(_popperjs_core__WEBPACK_IMPORTED_MODULE_5__["createPopper"])(_this.$refs.handle.firstElementChild || _this.$refs.handle, node, {
        ...
        _this.eventListener = window.addEventListener("resize", function (event) {
          _this.hidePopper();

          setTimeout(function () {
            _this.$refs.node.style.transform = "";
          }, 0);
        });
  ...
  return _c("div", [
    ...
    _c(
      ...
      [
        ...
        _vm._v(" "),
        _c("div", { ref: "arrow", staticClass: "popover-arrow" })
      ]
    )
  ])
}
