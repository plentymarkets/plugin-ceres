    ...
    sendReturnItems: function sendReturnItems() {
      ...
      this.sendOrderReturn().then(function (response) {
        ...
        if (_this.$store.getters.isLoggedIn) {
          Object(_services_UrlService__WEBPACK_IMPORTED_MODULE_12__["navigateTo"])(App.urls.myAccount);
        } else {
          Object(_services_UrlService__WEBPACK_IMPORTED_MODULE_12__["navigateTo"])(App.urls.confirmation);
        }
      }, function (error) {
