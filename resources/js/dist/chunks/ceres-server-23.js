...
var render = function() {
  ...
  return _c(
    ...
    [
      _vm._ssrNode(
        '<div data-validate="password" class="input-feedback-container">',
        "</div>",
        [
          _vm._ssrNode(
            ...
            [
              ...
              _vm._ssrNode(
                " <label" +
                  _vm._ssrAttr("for", _vm._uid + "password_first") +
                  ">" +
                  _vm._ssrEscape(
                    _vm._s(
                      _vm.$translate("Ceres::Template.resetPwNewPassword")
                    ) + "*"
                  ) +
                  "</label>"
              )
      ...
      _vm._ssrNode(
        ' <div data-validate="ref" class="input-feedback-container"><div class="input-unit"><input type="password" name="password" autocomplete="new-password"' +
          _vm._ssrAttr("id", _vm._uid + "password_second") +
          _vm._ssrAttr("data-validate-ref", "#" + _vm._uid + "password_first") +
          _vm._ssrAttr("value", _vm.passwordSecond) +
          "> <label" +
          _vm._ssrAttr("for", _vm._uid + "password_second") +
          ">" +
          _vm._ssrEscape(
            _vm._s(_vm.$translate("Ceres::Template.resetPwRepeatPassword")) +
              "*"
          ) +
          "</label></div></div> <button" +
          _vm._ssrAttr("disabled", _vm.isDisabled) +
          ' class="btn btn-primary btn-appearance btn-large float-right"><span>' +
          _vm._ssrEscape(
            _vm._s(_vm.$translate("Ceres::Template.resetPwSave"))
          ) +
          '</span> <i aria-hidden="true" class="fa fa-floppy-o"></i></button>'
      )
    ],
    2
  )
...
//# sourceMappingURL=ceres-server-23.js.map