...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: _objectSpread({
    ...
    hasError: function hasError() {
      ...
      var isTextNumberInput = this.inputType === "int" || this.inputType === "float" || this.inputType === "text";

      if (isTextNumberInput && ((_this$property = this.property) === null || _this$property === void 0 ? void 0 : (_this$property$value = _this$property.value) === null || _this$property$value === void 0 ? void 0 : _this$property$value.length) > 128) {
        return true;
      }
