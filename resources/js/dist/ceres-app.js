...
Vue.component("login", {
    ...
    methods: {
        ...
        validateResetPwd: function validateResetPwd() {
            ...
            if (this.isPwdReset) {
                _ValidationService2.default.validate($("#reset-pwd-form-" + this._uid)).done(function (data) {
                    _this2.sendResetPwd();
                }).fail(function (invalidFields) {
                    _ValidationService2.default.markInvalidFields(invalidFields, "error");
                });
        ...
        sendResetPwd: function sendResetPwd() {
            ...
            ApiService.post("/rest/io/customer/password_reset", { email: this.username }).done(function (data) {
        ...
        showResetPwdView: function showResetPwdView() {
            var tooltip = "data-toggle=\"tooltip\" data-placement=\"right\" title=\"jknk\"";
