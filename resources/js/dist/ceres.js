...
var mutations = {
    ...
    setCheckout: function setCheckout(state, checkout) {
        this.setShippingCountryId(state, checkout.shippingCountryId);
        this.setShippingProfile(state, checkout.shippingProfileList.find(function (profile) {
            return profile.parcelServicePresetId === checkout.shippingProfileId;
        }));
        this.setShippingProfileList(state, checkout.shippingProfileList);
        this.setMethodOfPayment(state, checkout.methodOfPaymentList.find(function (profile) {
            return profile.id === checkout.methodOfPaymentId;
        }));
        this.setMethodOfPaymentList(state, checkout.methodOfPaymentList);
    }
};
