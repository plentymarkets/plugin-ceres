            ...
            <div class="row py-3" v-show="!isExpanded" :class="classes" :style="styles">
                <div class="col-12 col-md-8">
                    ...
                    <div>
                        ...
                        <a href="#" class="text-primary text-appearance d-block d-md-inline-block" v-testing-attr:data-testing="'cookieBarShowMoreInformation'" @click.prevent.stop="isExpanded=true">{{ $translate("Ceres::Template.cookieBarMoreSettings") }}</a>
                    </div>
                ...
                <div class="col-12 col-md-4 pt-3 pt-md-0">
                    <button
                        ...
                        v-testing-attr:data-testing="'cookieBarAcceptAll'">
                        {{ $translate("Ceres::Template.cookieBarAcceptAll") }}
                    </button>
                    <button
                        class="btn btn-default btn-block"
                        @click="storeConsents(); close()"
                        v-testing-attr:data-testing="'cookieBarSave'">
            ...
            <div class="row py-3" v-if="isExpanded" :class="classes" :style="styles">
                ...
                <div class="col-12 col-md-6">
                    <a
                        ...
                        v-testing-attr:data-testing="'cookieBarHideMoreInformation'"
                ...
                <div class="col-6 col-md-3">
                    <button
                        ...
                        @click="acceptAll(); close()"
                        v-testing-attr:data-testing="'cookieBarExpandedAcceptAll'">
                        {{ $translate("Ceres::Template.cookieBarAcceptAll") }}
                    </button>
                </div>
                <div class="col-6 col-md-3">
                    <button
                        ...
                        @click="storeConsents(); close()"
                        v-testing-attr:data-testing="'cookieBarExpandedSave'">
                        {{ $translate("Ceres::Template.cookieBarSave") }}
                    </button>
                </div>
            </div>
