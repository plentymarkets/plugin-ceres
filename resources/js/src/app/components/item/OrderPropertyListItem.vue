<template>
    <div class="position-relative">
        ...
        <div v-else-if="inputType === 'file'" class="d-flex">
            ...
            <popper class="order-property-selection-info-popper" v-cloak v-show="isTouchDevice" v-if="property.names.description" placement="bottom">
                <template #handle>
                    <button class="btn btn-icon btn-circle btn-default btn-appearance font-weight-bold">?</button>
                </template>
                <template #content>
        ...
        <popper class="order-property-selection-info-popper position-absolute" :class="{ 'checkbox-or-radio': inputType === 'checkbox' || inputType === 'radio'}" v-cloak v-show="isTouchDevice" v-if="inputType !== 'selection' && inputType !== 'file' && property.names.description" placement="bottom">
            <template #handle>
                <button class="btn btn-icon btn-circle btn-default btn-appearance font-weight-bold">?</button>
            </template>
            <template #content>
