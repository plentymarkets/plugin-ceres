                ...
                <div><!-- v-stick-in-parent -->
                  ...
                  <div :class="'availabilityRow availabilityRow_' + currentVariation.variation.availability.id">
                    <biokinder-availability :avd="$attrs.availabilitydata"
                      :variation="currentVariation.variation"></biokinder-availability>
                  </div>
                  ...
                  <div class="singleartprice mb-3" itemprop="offerDetails" itemscope=""
                    ...
                    <span data-toggle="collapse" aria-expanded="false" class="variationManufacturer"
                      ...
                      <img v-if="currentVariation.item.manufacturer.id && currentVariation.item.manufacturer.logo"
                        :src="currentVariation.item.manufacturer.logo"
                        :alt="'Marken-Logo-' + currentVariation.item.manufacturer.externalName" />
                    </span>
                    <div class="variationPrice">
                      <graduated-prices></graduated-prices>
                      <item-price></item-price>
                      <input type="hidden" id="stdShippingCosts"
                        :value="currentVariation.variation.defaultShippingCosts" />

                      <slot
                        v-if="currentVariation.prices.default.price && currentVariation.prices.default.price.value > 200"
                  ...
                  <add-to-basket :variation-id="currentVariation.variation.id"
                    ...
                    :use-large-scale="false" :show-quantity="true" :item-url="currentVariation | itemURL"
                  ...
                  <div v-if="hasProperty(166)" class="siegelContainer">
                    <a v-if="hasPropertySelection(166, 346)" href="/textseiten/natuerliche-rohstoffe/"
                      alt="Natürliche Rohstoffe" aria-label="Natürliche Rohstoffe" click-count>
                      <img :src="'https://cdn.bio-kinder.de/frontend/seals/natural.svg'" alt="Natürliche Rohstoffe" />
                    </a>
                    <a v-if="hasPropertySelection(166, 275)"
                      href="/textseiten/bio-erlenholzmoebel-kindermoebel-fuer-babys-und-kinder/"
                      aria-label="Bio-Erlenholz" alt="Bio-Erlenholz" click-count>
                      <img :src="'https://cdn.bio-kinder.de/frontend/seals/alderwood.svg'" alt="100% Bio-Erlenholz" />
                    </a>

                    <img v-if="hasPropertySelection(166, 449)" :src="'https://cdn.bio-kinder.de/frontend/seals/oak.svg'"
                      alt="Bio-Eichenholz" />

                    <a v-if="hasPropertySelection(166, 276)" href="/textseiten/bio-kiefernholz-von-bio-kinder/"
                      aria-label="Bio-Kiefernholz" alt="Bio-Kiefernholz" click-count>
                      <img :src="'https://cdn.bio-kinder.de/frontend/seals/pinewood.svg'" alt="100% Bio-Kiefernholz" />
                    </a>
                    <a v-if="hasPropertySelection(166, 345)" href="/content/10-jahre-garantie/"
                      aria-label="Möbelgarantie" alt="Möbelgarantie" click-count>
                      <img :src="'https://cdn.bio-kinder.de/frontend/seals/guarantee.svg'"
                        alt="10 Jahre Möbel-Garantie" />
                    </a>
                    <a v-if="hasPropertySelection(166, 344)" href="/content/100-fair-produziert/"
                      aria-label="Fair produziert" alt="Fair produziert" click-count>
                      <img :src="'https://cdn.bio-kinder.de/frontend/seals/fair.svg'" alt="Fair produziert" />
                    </a>
                    <img v-if="hasPropertySelection(166, 403)"
                      :src="'https://cdn.bio-kinder.de/frontend/seals/organictreewool.svg'" alt="kbA Baumwolle" />
                    <img v-if="hasPropertySelection(166, 404)"
                      :src="'https://cdn.bio-kinder.de/frontend/seals/sheepwool.svg'" alt="100% Schurwolle" />
                  </div>

                  <div v-if="hasProperty(166)" class="siegelContainer">
                    <img data-toggle="modal" class="bioolaLogo" data-target="#bioola"
                      v-if="hasPropertySelection(166, 274)"
                      :src="'https://cdn.bio-kinder.de/frontend/assets/bioola/bioola.svg'" alt="bioola Lasur" />
                    <img class="softCloseLogo" v-if="hasPropertySelection(166, 622)"
                      :src="'https://cdn.bio-kinder.de/frontend/seals/soft_close.svg'" alt="Soft-Close" />
                    <img v-if="hasPropertySelection(166, 617)"
                      :src="'https://cdn.bio-kinder.de/frontend/seals/din1729.svg'" alt="DIN geprueft" />
                    <img style="max-height:80px" v-if="hasPropertySelection(166, 652)"
                      :src="'https://cdn.bio-kinder.de/frontend/images/icons/made_in_germany.svg'"
          ...
          <div class="row">
            ...
            <div class="col-md-5" id="rightSide">
              <div class="descriptionContainer shippingInfo">
                <biokinder-shipping-icon :variation="currentVariation.variation" :avd="$attrs.availabilitydata"
                  :availability="currentVariation.variation.availabilityId" :shipping="calcDefaultShippingCosts"
              ...
              <template v-if="hasProperty(197)">
                <div class="descriptionContainer instagram">
                  <button class="btn btn-block text-left descriptionButton collapsed" data-toggle="modal"
                    data-target="#instagramModal" aria-label="Instagram Gallerie" click-count>
                  ...
                  <!-- Modal -->
                  <div class="modal fade" :variationId="currentVariation.variation.id" id="instagramModal" tabindex="-1"
                    role="dialog" aria-labelledby="Beiträge aus der Community" aria-hidden="true">
              ...
              <!-- Manufacturer -->
              <div id="manufacturerDetail" class="descriptionContainer"
                v-if="currentVariation.item.manufacturer.id && currentVariation.item.manufacturer.logo">
                <button class="btn btn-block text-left descriptionButton collapsed" data-toggle="collapse"
                  data-target="#manufacturer" aria-expanded="false" aria-controls="manufacturer"
                  :aria-label="'Hersteller-Details: ' + currentVariation.item.manufacturer.externalName" click-count>
                ...
                <div id="manufacturer" class="collapse mt-1" aria-labelledby="manufacturer" data-parent="#rightSide">
                  <img :src="currentVariation.item.manufacturer.logo" class="producerlogo_article col-md-8 offset-md-2"
                    :alt="'Marken-Logo-' + currentVariation.item.manufacturer.externalName" />
                  <div v-html="currentVariation.item.manufacturer.comment"></div>
                  <a :href="'/markenwelt/?marke=' + currentVariation.item.manufacturer.id"
                    class="btn btn-block btn-sm btn-bkm"
                    :aria-label="'Mehr Artikel von ' + currentVariation.item.manufacturer.externalName"
                    click-count>Weiteres Sortiment entdecken <i data-feather="chevron-right"></i></a>
                </div>
              </div>
              ...
              <template v-if="showBundleComponents">
                <div id="bundleDetail" class="descriptionContainer">
                  <button class="btn btn-block text-left descriptionButton collapsed" data-toggle="collapse"
                    data-target="#bundleComponents" aria-expanded="false" aria-controls="bundleComponents"
                    aria-label="Paketbestandteile anzeigen" click-count>
                    <svg viewBox="0 0 24 24" width="22" height="22" stroke="currentColor" stroke-width="1.5" fill="none"
                      stroke-linecap="round" stroke-linejoin="round" class="icon-bundle">
                  ...
                  <div id="bundleComponents" class="collapse mt-1" aria-labelledby="bundleComponents"
                    data-parent="#rightSide">
                    <article v-for="bundleComponent in currentVariation.bundleComponents"
                      class="itemCategoryProduct horizontal">
                      <div class="produkt_picture">
                        <a :href="bundleComponent.data.texts.urlPath + '_' + bundleComponent.data.variation.itemId + '_' + bundleComponent.data.variation.id + '/'"
                          aria-label="Paketbestandteil" click-count>
                          <picture v-if="bundleComponent.data.images.variation[0]" data-picture-class="img-fluid"
                      ...
                      <div class="productInfoContainer">
                        <div class="productName">
                          ...
                          <p class="variationHint" v-if="bundleComponent.data.attributes"><span class="text-left"
                              v-for="attribute in bundleComponent.data.attributes"><span
                                v-html="attribute.attribute.names.name + ': ' + attribute.value.names.name"></span></span>
                          </p>
                        </div>
                      </div>
                    </article>
              ...
              <div class="descriptionContainer">
                <div id="application">
                  <button class="btn btn-block text-left descriptionButton collapsed" data-toggle="collapse"
                    data-target="#applicationContainer" aria-expanded="false" aria-controls="applicationContainer"
                    aria-label="Technische Daten" click-count>
                    <svg viewBox="0 0 24 24" width="22" height="22" stroke="currentColor" stroke-width="1.5" fill="none"
                      stroke-linecap="round" stroke-linejoin="round" class="icon-technicaldata">
              ...
              <template
                ...
                <div class="descriptionContainer"
                  v-for="vProperty in $store.getters.currentItemVariation.variationProperties.filter(function (prop) { return (prop.id == 4) })[0].properties.filter(function (prop) { return (prop.id == 191) })">
                  <button class="btn btn-block text-left descriptionButton collapsed" data-toggle="collapse"
                    data-target="#careTaking" aria-expanded="false" aria-controls="careTaking"
                    aria-label="Pflegehinweise" click-count>
                    <svg viewBox="0 0 24 24" width="22" height="22" stroke="currentColor" stroke-width="1.5" fill="none"
                      stroke-linecap="round" stroke-linejoin="round" class="icon-care">
              ...
              <div class="descriptionContainer">
                <button class="btn btn-block text-left descriptionButton collapsed" data-toggle="collapse"
                  data-target="#supportBox" aria-expanded="false" aria-controls="supportBox"
                  aria-label="Sie haben Fragen?" click-count>
                ...
                <div id="supportBox" class="collapse" aria-labelledby="more_details" data-parent="#rightSide">
                  <div class="descriptionContent">
                    <p>Wir helfen Ihnen gerne! Rufen Sie uns an oder schreiben Sie uns eine Nachricht. Wir stehen Ihnen
                      Montags bis Freitags von 8:00 bis 16:00 Uhr zur Verfügung und beraten Sie gerne.</p>
                    ...
                    <form class="row" id="12fd" method="post"
                      @submit.prevent="$store.dispatch('sendContactForm', $event)">
                      ...
                      <div class="col-12 cmp-contact">
                        ...
                        <div class="input-unit">
                          <input name="product" disabled="disabled" type="text"
                            :value="currentVariation.item.id + '-' + currentVariation.variation.id + ' ' + this.$options.filters.itemName(currentVariation)"
                            id="product">
                          <label for="product">
                            Produkt
                          </label>
