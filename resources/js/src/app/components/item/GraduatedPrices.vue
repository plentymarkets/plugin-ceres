        ...
        <table class="graduated-prices-table text-muted">
            <template v-for="(price, index) in graduatedPrices">
                ...
                <tr v-if="showBasePrice">
                    <td :class="paddingClasses" :style="paddingInlineStyles" class="graduated-base-price d-xl-none pb-2" colspan="2">{{ $translate("Ceres::Template.singleItemGraduatedBasePrice", { "price": price.basePrice }) }}</td>
                </tr>
            </template>
        </table>
        <br>
