            ...
            <div class="col-12">
                ...
                <div class="row">
                    <div class="col-12" v-if="isInOptionalFields('de', 'delivery_address.email')">
                        <div class="input-unit" data-model="email" v-validate:text="isInOptionalFields('de', 'delivery_address.email')">
            ...
            <div class="col-12">
                ...
                <div class="row">
                    <div class="col-12" v-if="isInOptionalFields('de', 'billing_address.email')">
                        <div class="input-unit" data-model="email" v-validate:text="isInOptionalFields('de', 'billing_address.email')">
            ...
            <div class="col-12">
                ...
                <div class="row">
                    <div class="col-12" v-if="isInOptionalFields('gb', 'billing_address.email')">
                        <div class="input-unit" data-model="email" v-validate:text="isInOptionalFields('gb', 'billing_address.email')">
            ...
            <div class="col-12">
                ...
                <div class="row">
                    <div class="col-12" v-if="isInOptionalFields('gb', 'delivery_address.email')">
                        <div class="input-unit" data-model="email" v-validate:text="isInOptionalFields('gb', 'delivery_address.email')">
