        ...
        <form :id="'login-form-' + _uid" method="post">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="input-unit" data-validate="mail">
                            <input data-testing="emailLogin" type="email" name="email" autocomplete="email" :id="'email' + _uid" v-model="username" data-autofocus>
                    ...
                    <div class="col-12">
                        <div class="input-unit" :class="{'no-bottom': modalElement}" data-validate="text">
                            <input data-testing="passwordLogin" type="password" name="password" autocomplete="current-password" :id="'password' + _uid" v-model="password">
            ...
            <div :class="{'modal-footer justify-content-between': modalElement, 'row': !modalElement}">
                ...
                <div :class="{'col-5 col-sm-8 text-sm-right': !modalElement}">
                    ...
                    <button data-testing="submitLogin" @click.prevent="validateLogin" :disabled="isDisabled" class="btn btn-primary btn-appearance btn-medium" :class="[{'float-right': !modalElement}, buttonSizeClass]">
