                   ...
                   <div class="basket-preview-content d-flex flex-fill">
                        ...
                        <coupon class="mb-3"></coupon>
                         <div class="toggleSelect w-100">
                          ...
                          <basket-totals
                            preview="true"
                           :visible-fields="['basketValueGross', 'promotionCoupon', 'shippingCostsGross', 'additionalCosts', 'salesCoupon', 'totalSumGross']"></basket-totals>
                          </div>
                           <div class="basket-preview-footer d-flex pb-3">
                               <a v-waiting-animation-infinite :href="$ceres.urls.basket" rel="nofollow" class="btn btn-bkm-inverted btn-block" :title="$translate('Ceres::Template.basket')">
                                   <i class="fa fa-shopping-cart"></i>
                                   {{ $translate("Ceres::Template.basket") }}
                               </a>

                               <slot name="before-checkout-button"></slot>
                               <a v-waiting-animation-infinite :href="$ceres.urls.checkout" rel="nofollow" class="btn btn-bkm btn-block" :title="$translate('Ceres::Template.basketCheckout')">
