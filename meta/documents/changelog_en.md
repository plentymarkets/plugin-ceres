...
- The plugin configuration contains a new setting in the **Header** section. You can use the setting to adjust the image size that is delivered via the Rich Snippets.
### Changed
