...
- Im Tabs-Widget gibt es die neue Einstellung **Einzigartige ID**. Mit dieser Einstellung können Fälle gelöst werden, in denen Inhalte in mehreren Tabs dupliziert waren. Du kannst eine einzigartige ID eingeben, um sicherzustellen, dass in jedem Tab die richtigen Inhalte dargestellt werden.
