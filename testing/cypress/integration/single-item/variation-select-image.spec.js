...
context("Variation Select - Image", () =>
{
    ...
    */
    ...
    it("should check for correct images of all variants of item 144", () =>
    {
        ...
        cy.get(".single-carousel").find("source").first().should('have.attr', 'srcset', 'https://cdn02.plentyone.com/2x3z2pucy2z9/item/images/144/middle/schwarz.jpg.avif');
        cy.getByTestingAttr("variation-select-box").eq(1).find("img").should('have.attr', 'src', 'https://cdn02.plentyone.com/2x3z2pucy2z9/item/images/144/preview/schwarz.jpg');
        
        cy.getByTestingAttr("variation-select-box").eq(2).click();
        cy.get(".single-carousel").find("source").first().should('have.attr', 'srcset', 'https://cdn02.plentyone.com/2x3z2pucy2z9/item/images/144/middle/lila.jpg.avif');
        cy.getByTestingAttr("variation-select-box").eq(2).find("img").should('have.attr', 'src', 'https://cdn02.plentyone.com/2x3z2pucy2z9/item/images/144/preview/lila.jpg');
        
        cy.getByTestingAttr("variation-select-box").eq(3).click();
        cy.get(".single-carousel .owl-item.active").find("source").first().should('have.attr', 'srcset', 'https://cdn02.plentyone.com/2x3z2pucy2z9/item/images/144/middle/lila.jpg.avif');
