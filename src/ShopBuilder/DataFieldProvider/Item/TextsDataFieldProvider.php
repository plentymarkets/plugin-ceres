...
class TextsDataFieldProvider extends DataFieldProvider
{
    function register()
    {
        ...
        $this->addField("shortDescription", "Ceres::Widget.dataFieldTextsShortDescription", "{{ item_data_field_html('texts.shortDescription') }}");
        $this->addField("description", "Ceres::Widget.dataFieldTextsDescription", "{{ item_data_field_html('texts.description') }}");
        $this->addField("technicalData", "Ceres::Widget.dataFieldTextsTechnicalData", "{{ item_data_field_html('texts.technicalData') }}");
