...
class AvailabilityDataFieldProvider extends DataFieldProvider
{
    function register()
    {
        ...
        $this->addField("Ceres::Widget.dataFieldAvailabilityIcon", "{{ item_data_field('variation.availability.icon') }}"); // not in result fields
        $this->addField("Ceres::Widget.dataFieldAvailabilityAvgDeliveryDays", "{{ item_data_field('variation.availability.averageDays') }}"); // not in result fields
        ...
        $this->addField("Ceres::Widget.dataFieldAvailabilityAvailableUntil", "{{ item_data_field('variation.availableUntil') }}"); // not in result fields
    }
}