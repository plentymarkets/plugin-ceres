...
class DefaultLoginPreset implements ContentPreset
{
    ...
    {
        $this->structurWidget = $this->preset->createWidget("Ceres::TwoColumnWidget")
                                             ->withSetting("layout", "oneToOne");
    }

    private function createLoginWidget()
    {
        $this->structurWidget->createChild("first", "Ceres::LoginWidget")
    ...
    {
        $this->structurWidget->createChild("first", "Ceres::InlineTextWidget")
    ...
    {
        $registerLinkWidget = $this->structurWidget->createChild("first", "Ceres::LinkWidget")
                                                   ->withSetting("customClass","")
