...
/**
 * Class DefaultDeclarationOfAccessibilityPreset
 *
 * This is a preset for ShopBuilder contents. Presets can be applied during content creation to generate a default content with predefined and configured widgets.
 * This particular preset generates a page for viewing the shop's declaration of accessibility. It contains:
 * - CodeWidget
 * - SeparatorWidget
 * - LegalTextsWidget
 *
 ...
 */
class DefaultDeclarationOfAccessibilityPreset implements ContentPreset
{
    ...
    private function createHeadline()
    {
        ...
        $text .= '<h1 class="print-header">{{ trans("Ceres::Template.declarationOfAccessibility", {"hyphen": "&shy;"}) }}</h1>';
        $text .= '{% endautoescape %}';
    ...
    private function createLegalTextsWidget()
    {
        $this->preset->createWidget("Ceres::LegalTextsWidget")
            ->withSetting("type", "declarationOfAccessibility")
            ->withSetting("spacing.customMargin", true)
            ->withSetting("spacing.margin.bottom.value", 0)
            ->withSetting("spacing.margin.bottom.unit", null);
    }
