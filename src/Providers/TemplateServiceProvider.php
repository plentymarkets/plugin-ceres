...
class TemplateServiceProvider extends ServiceProvider
{
    ...
    private static $templateKeyToViewMap =
        [
            ...
            'tpl.wish-list' => ['WishList.WishListView', CategoryContext::class],
            'tpl.wish-list.detail' => ['WishList.WishListDetailView', CategoryContext::class],
            'tpl.wish-list.access-code' => ['WishList.WishListAccessKeyView', CategoryContext::class],
